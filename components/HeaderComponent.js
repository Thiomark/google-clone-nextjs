        ...
        home ? (
            ...
            <header className='sticky top-0 bg-white border-b'>
                <div className="flex w-full p-6">
                    ...
                    />
                    <form onSubmit={(e) => submitSearch(e)} style={{maxWidth: '44em'}} className='flex px-6 py-3 ml-10 mr-5 flex-grow border border-gray-200 rounded-full shadow-md items-center'>
