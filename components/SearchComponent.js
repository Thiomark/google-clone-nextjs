...
const SearchComponent = () => {
    ...
    return (
        <form onSubmit={(e) => submitSearch(e)} className='mx-5 flex flex-col items-center mt-44 flex-grow'>
            <Image 
                className='m-auto'
                width={300}
                height={100}
            ...
            <div className="flex space-x-4">
                ...
                <p className='links-languages'>Afrikaans</p>
                <p className='links-languages'>Sesotho</p>
                <p className='links-languages'>isiZulu</p>
                <p className='links-languages'>IsiXhosa</p>
                <p className='links-languages'>Setswana</p>
                <p className='links-languages'>Northern Sotho</p>
            </div>
        </form>
    )
}
